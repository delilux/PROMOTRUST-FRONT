...
@Component({
  selector: 'app-actualizarcontratousuario',
  ...
  templateUrl: './actualizarcontratousuario.component.html',
  styleUrl: './actualizarcontratousuario.component.css',
})
export class ActualizarcontratousuarioComponent implements OnInit {
